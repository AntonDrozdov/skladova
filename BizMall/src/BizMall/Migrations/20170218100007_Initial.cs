    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelGoodExternalLink", x => new { x.ExternalLinkId, x.GoodId });
                    table.ForeignKey(
                        name: "FK_RelGoodExternalLink_ExternalLink_ExternalLinkId",
                        column: x => x.ExternalLinkId,
                        principalTable: "ExternalLink",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RelGoodExternalLink_Articles_GoodId",
                        column: x => x.GoodId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelGoodExternalLink_ExternalLinkId",
                table: "RelGoodExternalLink",
                column: "ExternalLinkId");

            migrationBuilder.CreateIndex(
                name: "IX_RelGoodExternalLink_GoodId",
                table: "RelGoodExternalLink",
                column: "GoodId");
